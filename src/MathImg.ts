...
export class MathImg {
  ...
  public static bilineal(img: ImageType, puntos_a : number [], puntos_b : number []): number[][][] {
   ...
   /* console.log(puntos_a[0]);
    ...
    const x1r=puntos_a[0],  y1r=puntos_b[0], x2r=puntos_a[1],   y2r=puntos_b[1], 
      x3r = puntos_a[2], y3r = puntos_b[2], x4r = puntos_a[3], y4r = puntos_b[3];
